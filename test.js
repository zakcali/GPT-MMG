...
const mistakes = [
    '<span class="ANAT">Sol memenin</span> MLO ve CC mammogramları elde olunmuştur',
    'Sol memenin MLO ve CC mammogramları elde olunmuştur',
    '<span class="ANAT">Sağ memenin</span> MLO ve CC mammogramları elde olunmuştur',
    'Sağ memenin MLO ve CC mammogramları elde olunmuştur',
    '<span class="ANAT">SAĞ</span> MAMMOGRAFİ RAPORUNUN DA OKUNMASI ÖNERİLİR',
    'SAĞ MAMMOGRAFİ RAPORUNUN DA OKUNMASI ÖNERİLİR',
    '<span class="ANAT">SOL</span> MAMMOGRAFİ RAPORUNUN DA OKUNMASI ÖNERİLİR',
    'SOL MAMMOGRAFİ RAPORUNUN DA OKUNMASI ÖNERİLİR'
    ];

async function run() {
    const model = genAI.getGenerativeModel({ model: "gemini-1.5-pro-latest" }, {
        apiVersion: 'v1beta', generationConfig, safetySettings
    });
    // read prompt
    let prompt;
    try {
